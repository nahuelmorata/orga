...
#include "planificador.h"
    ...
    * @param int cantidad El tamaño del arreglo
    ...
    */
	...
	/**
    * Ordena las ciudades recibidas por una prioridad dada
    * @param int(*prioridad)(TEntrada,TEntrada) Un puntero a una funcion de priorid
    ...
    * @return El arreglo sin la ciudad eliminada
    */
	TColaCP ordenar(int(*prioridad)(TEntrada,TEntrada), TCiudad ciudad_actual, TCiudad arr_ciudades[], int cantidad){
